...
public class Record implements Initializable{
	...
	@FXML
	private PieChart ppbc;
	
	@Override
public void initialize(URL arg0, ResourceBundle arg1) {
		// 전체 회원수 
				int mtotal = MemberDao.memberDao.counttotal("javafx.member");
				lblmtotal.setText( mtotal+" 명");
				// 전체 제품수 
				int ptotal = MemberDao.memberDao.counttotal("javafx.product");
				lblptotal.setText( ptotal+" 개");
				// 전체 게시물수 
				int btotal = MemberDao.memberDao.counttotal("javafx.board");
