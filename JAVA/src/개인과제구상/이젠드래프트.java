...
public static void main(String[] args) {
	...
	ArrayList<팀원> 뽑은팀원 = new ArrayList<팀원>();
	while(true) {
		...
		int ch = sc.nextInt();
		if(ch==1) {
			이젠드래프트_인터페이스 팀장 = new 팀장("김규석", "캐리", 뽑은팀원, 5);
			팀장.팀장선택();
			
			
		}
		else if(ch==2) {
			이젠드래프트_인터페이스 팀장 = new 팀장("김지웅", "만능",뽑은팀원, 3 );
			팀장.팀장선택();
		}
		else if(ch==3) {
			이젠드래프트_인터페이스 팀장 = new 팀장("김진혁", "분업", 뽑은팀원, 1 );
			팀장.팀장선택();
		}
		else if(ch==4) {
			이젠드래프트_인터페이스 팀장 = new 팀장("김선제", "분업", 뽑은팀원, -1);
			팀장.팀장선택();
		}
		else if(ch == 5) {
			이젠드래프트_인터페이스 팀장 = new 팀장("박민욱", "소통", 뽑은팀원, -3);
			팀장.팀장선택();
		}
		else if(ch == 6) {
			이젠드래프트_인터페이스 팀장 = new 팀장("김명호", "X", 뽑은팀원, -5);
			팀장.팀장선택();
		}
		else if(ch == 7) {
			...
			if(ch1 == 1) {
				...
				String 시너지 = sc.next();
				boolean result = con.팀원등록(이름, 특성, 시너지);
				...
				boolean result = con.팀원편집(name, 이름, 특성, 시너지);
