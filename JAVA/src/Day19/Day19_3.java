...
public static void main(String[] args) {
	...
	//  * Map컬렉션 : 키(set)와 값(list)으로 이루어진 엔트리를 여러 개 저장 [ 순서 X ]
...
// HashMap : 컬렉션프레임워크 map 클래스
	...
	// key의 값은 중복불가능[ 기존 key가 없어지고 새로운 키로 대치 ]
	...
	// 4. map객체명.get(키) : map 객체내 키 -> 값 호출
	System.out.println("map 객체내 값 호출 (키 호출시 -> 값호출) : " + map.get("유재석"));
	...
	// 7. 반복문 [ key 반복문 이용하여 모든 value 호출 가능 ] 
