...
public class Member4 {
	// 1-2. member	: 필드(회원번호, 아이디, 비번, 이름, 연락처) 
			...
			String name;
			String phone;
			public Member4(String imem, String id, String pw, String name, String phone) {
				super();
				this.imem = imem;
				this.id = id;
				this.pw = pw;
			...
			void 회원가입 () {
				...
				System.out.println("아이디 : "); 			String id = 도서대여프로그램연습_4.sc.next();
			...
			void 비번찾기 () {
				...
				for(Member4 temp : 도서대여프로그램연습_4.memberlist) {
					...
					{
					System.out.println("비밀번호 : " + 도서대여프로그램연습_4.memberlist[i].pw);	 
					}
				i++;}
			}
			void 로그아웃 () {
